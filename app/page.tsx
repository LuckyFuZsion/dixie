  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <footer className="bg-slate-950/95 border-t border-white/10 py-4">
        <div className="container mx-auto px-4 grid grid-cols-4 gap-3 place-items-center md:flex md:flex-wrap md:justify-center md:items-center md:gap-6">
          <a href="https://rainbet.com/?r=tdd" target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 transition">
            <Image src="/images/rainbet-logo.png" alt="Rainbet" width={120} height={48} className="w-16 h-auto md:w-[120px]" />
          </a>
          ...
          <a href="https://webfuzsion.co.uk" target="_blank" rel="noopener noreferrer" className="opacity-80 hover:opacity-100 transition">
            <Image
              ...
              width={140}
              height={40}
              className="w-16 h-auto md:w-[140px]"
              priority
            />
          </a>
          <a href="https://discord.gg/KnnWbFkS" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 md:gap-2 px-2 py-1 md:px-3 md:py-1.5 rounded-md bg-slate-800 text-slate-100 border border-slate-600/50 hover:bg-slate-700 transition">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="text-indigo-300 w-5 h-5">
            ...
            <span className="hidden md:inline" style={{ fontFamily: 'var(--font-future)' }}>Join Discord</span>
          </a>
        </div>
      </footer>
    </main>
